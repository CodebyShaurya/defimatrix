...
export default function Page() {
  ...
  return (
    <AppLayout>
      <div className="mx-auto mt-32 flex w-full max-w-6xl flex-col items-center justify-center">
        <a href="./">
        ...
        <a
          ...
          target="_blank"
          className={`mt-4 flex items-center space-x-2 rounded-md bg-gradient-to-tr from-indigo-400 to-fuchsia-400 px-14 py-4 text-white shadow-md transition-all duration-150 ease-in-out hover:scale-95 hover:from-purple-900 hover:via-purple-600 hover:to-purple-900 hover:shadow-lg active:scale-90`}
        >
