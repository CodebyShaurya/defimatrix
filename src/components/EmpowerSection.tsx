...
export default function EmpowerSection() {
  return (
    <div className="hidden lg:block container relative mx-auto overflow-hidden border-x border-t border-white/10 px-4 py-32 lg:px-8 2xl:max-w-screen-2xl">
      <div className="mx-auto max-w-6xl lg:px-8 2xl:max-w-7xl">
        <div className="flex w-full flex-col items-center justify-end gap-x-8 gap-y-16 sm:gap-y-20 lg:flex-row">
          <div className="md:absolute md:left-20 md:right-0 max-w-4xl">
            <Marquee speed={5} direction={"bottom-top"}>
              <div className="flex flex-col gap-6">
                <div className="flex max-w-md items-center gap-2 rounded-2xl bg-white/10 p-4">
                  <Image
                ...
                <div className="mb-6 flex max-w-md items-center gap-2 rounded-2xl bg-white/10 p-4">
                  <Image
          ...
          {/* <div className="lg:hidden w-full">
            <Marquee speed={5} direction={"right-left"}>
              <div className="flex w-full gap-6">
                <div className="flex w-full flex-col w-64 items-center gap-2 rounded-2xl bg-white/10 p-4">
                  <Image
                    src="/images/people/p1.png"
                    alt="portal-logo"
                    width={120}
                ...
                <div className="mb-6 flex w-full flex-col w-64 items-center gap-2 rounded-2xl bg-white/10 p-4">
                  <Image
                    src="/images/people/p10.png"
                    alt="portal-logo"
                    width={120}
          ...
          <div className="lg:mt-0 mt-10 lg:max-w-lg ">
